#!C:\Program Files (x86)\Python\Python 2.7.18\python.exe 
...
if "guess" in form:
    ...
    for key, digit in enumerate(guess):#Will assine a digit from the guess to the variable digit and will assine it's key to the variable key.
        if digit == answer[key]:
            reds += 1
        else:
